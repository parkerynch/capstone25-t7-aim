export enum ErrorCode {
    ...
    REQUEST_BODY_UNREADABLE = 'AIMDEP00100',
    JSON_PARSE_ERROR = 'AIMDEP00101',
    INVALID_INPUT = 'AIMDEP00106',
    NOT_FOUND = 'AIMDEP00105',
    // ... 기존 에러 코드 추가 (워크플로우 맞춤)
    FAILED_TO_DECODE_BASE64 = 'AIMDEP00102',
    INVALID_ZIP_STRUCTURE = 'AIMDEP00103',
    S3_UPLOAD_FAILED = 'AIMDEP00104',
    ...
    LAMBDA_TIMEOUT = 'AIMDEP01201', // aim-hello-api 전용: Lambda 실행 시간 초과

    // Deployment Errors (300-399)
    LAMBDA_DEPLOYMENT_FAILED = 'AIMDEP00300',
    S3_STATIC_HOSTING_FAILED = 'AIMDEP00301',
    API_GATEWAY_CREATION_FAILED = 'AIMDEP00302',
}

// 에러 코드별 메타데이터
export const ErrorCodeMetadata: Record<ErrorCode, { message: string; httpStatus: number }> = {
...
export const getMessageByCode = (code: string): string => {
    const entry = Object.entries(ErrorCodeMetadata).find(([key]) => key === code);
